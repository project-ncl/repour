// Build a HTML version using scripts/make-readme.sh

= Repour - Archival Code Service
// Variable Definitions
// See http://www.python.org/dev/peps/pep-0440
:repourVersion: 0.10.0-dev0
// This is replaced by the current branch/tag and commit ID when HTML version is built.
:repourRevision: master

_Version {repourVersion} revision {repourRevision}_
